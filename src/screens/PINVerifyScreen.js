...
const PINVerifyScreen = ({ navigation }) => {
            ...
            [
              { text: 'Batal', style: 'cancel' },
              {
                ...
                onPress: async () => {
                  ...
                  // verifySuccess() sets isPINVerified=true, effectively unlocking the app state locally if needed
                  // but we want to go effectively to "No PIN" state.
                  // updatePINStatus checkPINStatus -> sets enabled=false, isPINVerified=false
                  // This should be enough for AppNavigator to re-route or allow access? 
                  // AppNavigator listens to isPINEnabled. If false, it routes to Main.
                  
                  // We manually navigate to Main just in case
                  navigation.replace('Main');
                }
              }
            ]
